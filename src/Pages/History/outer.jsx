    ...
    return (
        <div className="container mx-auto p-4">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {orders.map((order) => (
                                <tr key={order.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap ">
                                        <td className="px-6 py-4 whitespace-nowrap text-center cursor-pointer" onClick={() => handleInvoiceClick(order)}>
                                            <IconFileText />
                                        </td>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <div className="text-sm text-gray-900">{order.ordersDelivered}
                                                <a className="px-2 text-orange-300" href="/history/perticularhistory ">Show
                                                    <i className="pi p-2 pb-0 text-xs pi-arrow-right text-orange-300"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </td>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal}>
                <Invoice closeModal={closeModal} order={invoice} /> {/* Pass closeModal function */}
            </Modal>
        </div>
    )
}